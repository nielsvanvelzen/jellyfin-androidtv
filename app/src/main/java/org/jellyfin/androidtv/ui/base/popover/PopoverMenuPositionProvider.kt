...
class PopoverMenuPositionProvider(
	...
	override fun calculatePosition(
		...
		// Calculate position
		val x = (anchorBounds.left + insidePosition.x + biasX.dir * popupContentSize.width + offset.x)
		val y = (anchorBounds.top + insidePosition.y + biasY.dir * popupContentSize.height + offset.y)

		// Return position clamped to fit in window
		return IntOffset(
