...
import org.jellyfin.androidtv.ui.composable.rememberPositionInfo
...
fun Duration.formatted(includeHours: Boolean): String {
...
private fun PositionText(
	...
	val positionInfo by rememberPositionInfo(playbackManager)
